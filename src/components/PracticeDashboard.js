...
const PracticeDashboard = () => {
  ...
  const dashboardButtons = [
    { id: 1, title: 'Add Category', icon: <ListPlus size={24} color="#4CAF50" />, bgColor: '#e8f5e9', hoverBgColor: '#d7eddb' },
    { id: 2, title: 'Add Details', icon: <FileText size={24} color="#2196F3" />, bgColor: '#e3f2fd', hoverBgColor: '#d4e9f7' },
    { id: 3, title: 'Add Questions', icon: <Plus size={24} color="#FF9800" />, bgColor: '#fff3e0', hoverBgColor: '#ffe8cc' },
    { id: 4, title: 'Practice Test Students', icon: <Users size={24} color="#FF9800" />, bgColor: "#c8f0d1", hoverBgColor: '#ffe8cc' },
  ];
  ...
  const handleButtonClick = (id, title) => {
    ...
    switch (id) {
      case 1:
        ...
        break;
      case 2:
        navigate("/practicetestdetails");
        break;
      case 3:
        navigate("/practicetestquestions");
        break;
      case 4:
        navigate("/practiceteststudents");
        break;
      default:
        break;
    }
