...
const AdminVideoDashboard = () => {
  ...
  const dashboardButtons = [
    { id: 1, title: 'Add Video Syllabus Category', icon: <ListPlus size={24} color="#4CAF50" />, bgColor: '#e8f5e9', hoverBgColor: '#d7eddb' },
    { id: 2, title: 'Add Video Syllabus Details', icon: <FileText size={24} color="#2196F3" />, bgColor: '#e3f2fd', hoverBgColor: '#d4e9f7' },
    { id: 3, title: 'Video Syllabus Purchasers', icon: <Plus size={24} color="#FF9800" />, bgColor: '#fff3e0', hoverBgColor: '#ffe8cc' },
  ];
  ...
  const handleButtonClick = (id, title) => {
    ...
    switch (id) {
      case 1:
        ...
        break;
      case 2:
        navigate("/adminvideodetails");
        break;
      case 3:
        navigate("/adminvideopurchase");
        break;
      default:
        break;
    }
