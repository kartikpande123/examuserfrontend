...
const VideoSyllabusDashboard = () => {
  ...
  return (
    <div style={{ backgroundColor: '#f4f4f4', minHeight: '100vh' }}>
      ...
      >
        <h2 className="m-0">Video Study Materials Dashboard</h2>
        <button
          style={{
            padding: '12px 24px',
          ...
          onClick={() => navigate("/videosyllabusentry")}
        >
          My Video Study Materials
        </button>
      </div>
      ...
      {/* Video Syllabus Cards */}
      <Container fluid className="p-4">
        {filteredSyllabi.length === 0 ? (
          <div className="text-center py-5">
            <p style={{ color: '#1a3b5d', fontSize: '18px' }}>No video study materials found.</p>
          </div>
        ) : (
          <div className="row">
                ...
                >
                  ...
                  >
                    {syllabus.imageUrl ? (
                      ...
                      <div style={{ textAlign: 'center', color: 'white' }}>
                        <i className="bi bi-play-circle" style={{ fontSize: '60px' }}></i>
                  ...
                  <div className="card-body" style={{ padding: '20px' }}>
                    ...
                    <div style={{ marginBottom: '15px' }}>
                      ...
                      {syllabus.updatedAt && syllabus.updatedAt !== syllabus.createdAt && (
                        <div
                          ...
                          style={{ fontSize: '14px', color: '#666' }}
                        >
                          <i className="bi bi-arrow-clockwise me-2" style={{ color: '#1a3b5d' }}></i>
                          <span><strong>Updated:</strong> {new Date(syllabus.updatedAt).toLocaleDateString()}</span>
                        </div>
                      )}

                      {/* Price Badge - Moved to details */}
                      <div
                        className="d-flex align-items-center"
                        style={{ fontSize: '14px', color: '#666' }}
                      >
                    ...
                    <button
                      ...
                      onClick={() => handlePurchaseVideo(syllabus)}
                      onMouseEnter={(e) => {
                    ...
                    >
                      ...
                      {syllabus.fees === 0 ? 'Get Free Video' : 'Purchase Video'}
                    </button>
                  </div>
                </div>
              </div>
...
export default VideoSyllabusDashboard;