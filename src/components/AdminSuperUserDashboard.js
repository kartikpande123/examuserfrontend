...
const AdminSuperUserDashboard = () => {
  const [activeButton, setActiveButton] = useState(null);
  const navigate = useNavigate();

  const dashboardButtons = [
    { id: 1, title: 'Add Super User Subcription', icon: <ListPlus size={24} color="#4CAF50" />, bgColor: '#e8f5e9', hoverBgColor: '#d7eddb' },
    { id: 2, title: 'Super User Purchasers', icon: <FileText size={24} color="#2196F3" />, bgColor: '#e3f2fd', hoverBgColor: '#d4e9f7' },
  ];
  ...
  const handleButtonClick = (id, title) => {
    ...
    switch (id) {
      case 1:
        navigate("/adminsuperuser");
        break;
      case 2:
        navigate("/superuserpurchasers");
        break;
      default:
        break;
    }
...
export default AdminSuperUserDashboard;